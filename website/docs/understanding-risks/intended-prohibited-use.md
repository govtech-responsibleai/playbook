---
sidebar_label: "Intended and prohibited use"
sidebar_position: 2
---
...
Use this statement to scope [evaluation plans](../evaluating-ai-systems/index.md), [off-topic guardrails](../mitigations-controls/off-topic-scope.mdx), and [minimum launch checks](../start-here/minimum-bar-before-launch.md).
