---
sidebar_label: "Agentic risk categories"
sidebar_position: 6
---
...
Use the result to scope [agentic evals](../evaluating-ai-systems/agentic-evals.mdx) and [agentic safety controls](../mitigations-controls/agentic-safety-controls.mdx).
