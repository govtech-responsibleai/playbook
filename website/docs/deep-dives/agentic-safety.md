...
- [Agentic evals](../evaluating-ai-systems/agentic-evals.mdx) — task scenarios, tool-call attack surface, memory & state, multi-agent.
- [Agentic safety controls](../mitigations-controls/agentic-safety-controls.mdx) — least privilege, sandboxing, approval gates, kill switches.
