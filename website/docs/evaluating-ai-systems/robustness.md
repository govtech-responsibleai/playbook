...
There are some well-defined metrics you can use to measure retrieval performance: context precision (how much of what was retrieved is relevant) and context recall (how much of the relevant material was retrieved) are the usual pair, and both are implemented in open-source packages such as [DeepEval](https://deepeval.com/guides/guides-rag-evaluation) and [Ragas](https://docs.ragas.io/en/stable/concepts/metrics/available_metrics/).
