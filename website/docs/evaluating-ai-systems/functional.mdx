...
New in this release: functional evals are framed as product-specific utility evals, with worked case studies on branding and helpfulness. Grounding, abstention, and hallucination testing now lives on [Robustness evals](robustness.md).
