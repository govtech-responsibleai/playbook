...
<div className="metric-disclosures">
  ...
  <details className="metric-disclosure">
    ...
    <p>The Alt-Test is one way to measure the alignment of your LLM-as-a-Judge. It reframes the goal of evaluation from "Is the model correct?" to "To what extent do LLMs concur with human annotations?"</p>
