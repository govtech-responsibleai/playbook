...
<mark className="new-since-v1">*Coming soon — this section will cover how to detect when an LLM judge's behavior has drifted, and the cadence for re-validating against human annotations.*</mark>
...
<mark className="new-since-v1">*Coming soon — this section will cover how to set regression baselines and what change triggers a real alert vs. routine variation.*</mark>

### Model-version Migration Evals

<mark className="new-since-v1">*Coming soon — this section will cover how to run a comparison eval when migrating between model versions so behavior changes are caught before they reach users.*</mark>
