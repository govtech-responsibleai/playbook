...
| [**Fine-tuning**](finetuning.md)                      | A persistent behaviour or task-performance gap remains after simpler changes                  |
...
| [**Fine-tuning**](finetuning.md)                      | —                      | A persistent behaviour or task-performance gap remains after simpler changes             | Improve domain terminology, output format or task-specific behaviour |
