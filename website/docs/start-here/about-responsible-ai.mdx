...
import aiCycle from '@site/static/images/ai_cycle.png';
import raiCaseStudies from '@site/static/images/rai-case-studies.png';
...
<figure style={{textAlign: 'center', margin: '1rem 0'}}>
  <img src={raiCaseStudies} alt="Examples of how LLM systems can fail in the real world" style={{width: 'auto'}} />
...
<figure style={{textAlign: 'center', margin: '1rem 0'}}>
  <img src={aiCycle} alt="The AI life cycle consists of the data, model, and application" style={{width: 'auto'}} />
