...
We benefit a lot from open-source research, and we are happy to contribute back to the community through our open-sourced work such as [LionGuard 2](https://huggingface.co/collections/govtech/lionguard-2), [Kaleidoscope](https://github.com/govtech-responsibleai/kaleidoscope), and the [Agentic Risk &amp; Capability Framework](https://govtech-responsibleai.github.io/agentic-risk-capability-framework/). Check out our [Hugging Face page](https://huggingface.co/govtech) and our blog articles [here](https://blog.ai.gov.sg) too!
...
- [Clear understanding of Responsible AI](./about-responsible-ai.mdx) and its 6 principles.
