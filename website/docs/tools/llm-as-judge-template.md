---
sidebar_label: "LLM-as-judge template"
sidebar_position: 11
---
...
Validate the judge against human annotations before relying on it. See [LLM-as-judge evaluation](../evaluating-ai-systems/methods.mdx).
