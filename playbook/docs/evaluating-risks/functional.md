...
Use exact-match or structured metrics when outputs are constrained. Use rubrics, human evaluation, or LLM-as-judge methods when outputs are open-ended. See [Evaluation methods](methods.md).
