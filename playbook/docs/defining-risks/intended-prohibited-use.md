...
Use this statement to scope [evaluation plans](../evaluating-risks/designing-evaluation-plan.md), [off-topic guardrails](../mitigating-risks/off-topic-scope.md), and [minimum launch checks](../start-here/minimum-bar-before-launch.md).
