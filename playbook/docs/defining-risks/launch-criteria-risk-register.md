...
Use these criteria to guide [evaluation reports](../evaluation-testing/evaluation-report-template.md) and [mitigation decisions](../guardrails-mitigations/index.md).
