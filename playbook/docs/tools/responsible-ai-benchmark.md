...
For application launch readiness, combine benchmark results with [Designing an evaluation plan](../evaluation-testing/designing-evaluation-plan.md) and [Minimum bar before launch](../start-here/minimum-bar-before-launch.md).
