...
Use [RAG and grounding evals](../evaluation-testing/rag-grounding.md) to measure faithfulness, citation correctness, and abstention. A grounding guardrail should improve those metrics without causing excessive over-refusal.
